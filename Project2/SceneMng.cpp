...
const std::map<INPUT_ID, int>& SceneMng::GetKeyList(PLAYER_NUM player)
{
...
SceneMng::SceneMng() : _screenSize{800, 600}
{
	...
	_keyList[PLAYER_NUM::ONE].try_emplace(INPUT_ID::R_ROTA, KEY_INPUT_V);
	_keyList[PLAYER_NUM::ONE].try_emplace(INPUT_ID::L_LOTA, KEY_INPUT_B);
